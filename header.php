...
<head>
	...
	<?php // http://www.geekmaispasque.com/2012/04/utiliser-balises-html5-internet-explorer-ie8/ ?>
...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header" role="banner">
		<div class="site-branding">
			...
			<?php // Custom logo link to home, unnecessary to have link on site-title
			if ( has_custom_logo() ) : ?>
			...
			<?php // Necessary to link to home on site-title
			else: ?>
				<div class="bloc-title-desc">
					<?php
					if ( is_front_page() && is_home() ) : ?>
		...
		<nav id="main-navigation" class="site-navigation" role="navigation" aria-label='<?php _e( 'Primary Menu ', 'flooor' ); ?>'>
			<span class="screen-reader-text"><?php _e( 'Primary Menu', 'flooor' ); ?></span>
